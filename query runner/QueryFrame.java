...
/**
 * GUI for the query runner.
 * Improved for by Group 5.
 * Improvements we did are:
 * - Pre-populated connection properties.
 * - Allowed a "Write your own" option in the query drop down (in addition to the pre-listed queries).
 * - Made sure query text-box IS NOT editable for pre-listed queries.
 * - Made sure query text-box IS editable for "Write your own" queries.
 * - Made sure output box shows errors if there are any errors in database operations.
 * - Made sure the error shown in output box is consistently and nicely formatted.
...
public class QueryFrame extends javax.swing.JFrame {
    ...
    // Pre-populated database connection properties
    ...
    public QueryFrame(QueryRunner queryrunnerObj) {
        ...
        this.jComboBoxQuery.addItem("Write your own");
    ...
    private void initComponents() {
        ...
        jTextFieldDatabase.setText(m_queryrunner.database);
        jScrollPane1 = new javax.swing.JScrollPane();
        jTextArea1 = new javax.swing.JTextArea();
        jScrollPane2 = new javax.swing.JScrollPane();
        jTextArea2 = new javax.swing.JTextArea();
        jTextHostname = new javax.swing.JTextField();
        jTextHostname.setText(m_queryrunner.host);
        jTextFieldUser = new javax.swing.JTextField();
        jTextFieldUser.setText(m_queryrunner.user);
        ...
        jPasswordField1.setText(m_queryrunner.pass);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        if (szChoice.startsWith("Write")) {
            this.jTextArea1.setText("<Enter your query here>");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        boolean actionQuery = (m_queryChoice < 0 && !query.trim().toLowerCase().startsWith("select ")) ||
                (m_queryChoice >= 0 && this.m_queryrunner.isActionQuery(m_queryChoice));
        ...
        if (m_queryChoice < 0) {
            bOK = m_queryrunner.Execute(query);
            if (bOK) {
                if (!actionQuery) {
        ...
        } else if (this.m_queryrunner.isActionQuery(m_queryChoice)) {
